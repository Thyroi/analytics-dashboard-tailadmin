...
export default function ChartSection({
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.99 }}
      className="min-h-[420px] h-full w-full flex flex-col rounded-2xl border bg-white dark:bg-gray-800 shadow-sm pl-6 pr-3 pt-6 pb-6 transition-all duration-200
