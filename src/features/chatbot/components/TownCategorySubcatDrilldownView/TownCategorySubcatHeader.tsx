import type { TownCategorySubcatHeaderProps } from "./TownCategorySubcatDrilldownView.types";

export default function TownCategorySubcatHeader({
  townLabel,
  categoryLabel,
  totalInteractions,
  onBack,
}: TownCategorySubcatHeaderProps) {
  return (
