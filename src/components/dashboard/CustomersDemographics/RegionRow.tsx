    ...
    >
      <div className="flex min-w-0 flex-1 items-center gap-2">
        <span
          ...
          aria-hidden
        >
          {isOpen ? <Minus className="h-3 w-3" strokeWidth={3} /> : <Plus className="h-3 w-3" strokeWidth={3} />}
        </span>
        <div className="min-w-0">
          <div className="truncate text-sm text-gray-800 dark:text-white/90">{region}</div>
